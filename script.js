  ...
  if (contactForm) {
    contactForm.addEventListener('submit', async function (e) {
      ...
      try {
        ...
        const response = await fetch('https://formspree.io/f/xandlyyj', {
          method: 'POST',
          headers: {
...
${data.message}
        ...
        const mailtoLink = `mailto:mohibullahahmedfoysal@gmail.com?subject=${emailSubject}&body=${emailBody}`;
